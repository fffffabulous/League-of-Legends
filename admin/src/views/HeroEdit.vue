            ...
            <el-tabs type="border-card" value="basic">
                <el-tab-pane label="基本信息" name="basic">
                    ...
                    <el-form-item label="难度">
                        <el-rate style="margin-top: 0.6rem" v-model="model.scores.difficult" :max="9"
                                 show-score></el-rate>
                    </el-form-item>
                    ...
                    <el-form-item label="生存">
                        <el-rate style="margin-top: 0.6rem" v-model="model.scores.survive" :max="9"
                                 show-score></el-rate>
                    </el-form-item>
                ...
                <!-- 下面字段 model.partners item.description 都是和数据库对应的字段 可看server/model/hero.js模型定义的字段-->
                <el-tab-pane label="最佳搭档" name="partners">
                    <el-button @click="model.partners.push({})" size="small"><i class="el-icon-plus"></i>添加英雄</el-button>
                    <el-row type="flex" style="flex-wrap: wrap">
                        <el-col :md="12" v-for="(item, i) in model.partners" :key="i">
                            <el-form-item label="英雄">
                                <!-- filterable 过滤器 可以在 select 框中搜索选择-->
                                <el-select filterable v-model="item.hero">
                                    <!-- 循环展示英雄搭档下拉选项    :value 保存选取英雄的id :label下拉选择展示信息 -->
